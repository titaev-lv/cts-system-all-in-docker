...
CLIENTS=(
    ...
    "web-ui-hsm-trader|web-ui-hsm-trader|Trading|hsm-service/clients/web-ui-trader|Web UI to HSM (Trader)"
...
print_info "  • HSM clients (Trader OU): 5"
...
echo ""
echo "HSM Service (7 clients):"
echo "  • $PKI_ROOT/hsm-service/clients/web-ui-2fa/web-ui-hsm-2fa.{key,crt}"
echo "  • $PKI_ROOT/hsm-service/clients/web-ui-trader/web-ui-hsm-trader.{key,crt}"
